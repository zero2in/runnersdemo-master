...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        runnerEntity3.setRunnerAge(420);
        runnerEntity3.setAveragePace(420);

        LapTimeEntity laptime5 = new LapTimeEntity();
        laptime5.setLapNumber(1);
        laptime5.setTimeSeconds(420);
        laptime5.setRunner(runnerEntity3);

        LapTimeEntity laptime6 = new LapTimeEntity();
        laptime6.setLapNumber(1);
        laptime6.setTimeSeconds(420);
